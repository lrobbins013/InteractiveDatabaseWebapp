/*createSQLFiles -- writes sql script files that create databases
 * 
 * This programs takes file names of csv files are writes sql script 
 * files to create the dentist database
 * 
 * Author Levi Hill 12/6/16
 * 
 */
...
public class createTables {
	...
	/** writeSqlFile
	 * 
	 * Takes the names of all csv files and writes sql scripts to populate tables in sql 
	 * 
	 */
